                        ...
                        else
                        {
                            ...
                            if (confirm == true)
                            {
                                ...
                                if (CrossConnectivity.Current.IsConnected)
                                {
                                    ...
                                    await App.TodoManager.SendProspectRetailerMedia1Directly(host, database, ipaddress, contact, SyncStatus, id, photo1url);
                                    await App.TodoManager.SendProspectRetailerMedia2Directly(host, database, ipaddress, contact, SyncStatus, id, photo2url);
                                    await App.TodoManager.SendProspectRetailerMedia3Directly(host, database, ipaddress, contact, SyncStatus, id, photo3url);
                                    await App.TodoManager.SendProspectRetailerMedia4Directly(host, database, ipaddress, contact, SyncStatus, id, videourl);
