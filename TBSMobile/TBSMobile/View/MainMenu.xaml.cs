    ...
    public partial class MainMenu : ContentPage
    {
        ...
        public async void SyncUser(string host, string database, string contact, string ipaddress, byte[] pingipaddress)
        {
            ...
            if (reply.Status == IPStatus.Success)
            {
                try
                {
                    lblStatus.Text = "Initializing user data sync";
                    ...
                    if (resultCount > 0)
                    {
                        ...
                        if (changesresultCount > 0)
                        {
                            for (int i = 0; i < changesresultCount; i++)
                            {
                                try
                                {
                                    lblStatus.Text = "Checking client updates";
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (crresultCount > 0)
                                                    {
                                                        if (crlastUpdated > crgetUser.Result[0].LastUpdated)
                                                        {
                                                            ...
                                                            lblStatus.Text = "Syncing user updates of " + cruserID;
                                                        }
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        lblStatus.Text = "Syncing new user (" + cruserID + ")";
                                                    }
                        ...
                        else
                        {
                            try
                            {
                                lblStatus.Text = "Checking server updates";
                                        ...
                                        for (int i = 0; i < chuserresult.Count; i++)
                                        {
                                            ...
                                            if (chresultCount > 0)
                                            {
                                                if (chlastUpdated > chgetUser.Result[0].LastUpdated)
                                                {
                                                    ...
                                                    await conn.InsertOrReplaceAsync(chuser);
                                                    lblStatus.Text = "Syncing user updates of " + chuserID;
                                                }
                                            }
                                            else
                                            {
                                                ...
                                                await conn.InsertOrReplaceAsync(cheuser);
                                                lblStatus.Text = "Syncing new user (" + chuserID + ")";
                                            }
                                        }
                                    }
                                }
                    ...
                    else
                    {
                        try
                        {
                            lblStatus.Text = "Getting user data from server";
                            ...
                            if (response.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(content))
                                {
                                    ...
                                    {
                                        lblStatus.Text = "Syncing user " + (i + 1) + " out of " + userresult.Count;
            ...
            {
                lblStatus.Text = "Syncing user failed. Server is unreachable.";
            }
        }
                    ...
                    if (resultCount > 0)
                    {
                        ...
                        if (changesresultCount > 0)
                        {
                            for (int i = 0; i < resultCount; i++)
                            {
                                try
                                {
                                    lblStatus.Text = "Getting retailer from local database";
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (crresultCount > 0)
                                                    {
                                                        if (crlastUpdated > crgetRetailer.Result[0].LastUpdated)
                                                        {
                                                            ...
                                                            lblStatus.Text = "Syncing retailer updates of " + crfileAs;
                                                        }
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        lblStatus.Text = "Syncing new retailer (" + crfileAs + ")";
                                                    }
                                                }
                                                catch (Exception ex)
                                                {
                                        ...
                                        for (int i = 0; i < chcontactsresult.Count; i++)
                                        {
                                            ...
                                            if (chresultCount > 0)
                                            {
                                                if (chlastUpdated > chgetRetailer.Result[0].LastUpdated)
                                                {
                                                    ...
                                                    lblStatus.Text = "Syncing retailer updates of " + chfileAs;
                                                }
                                            }
                                            else
                                            {
                                                ...
                                                lblStatus.Text = "Syncing new retailer (" + chfileAs + ")";
                                            }
                                        }
                                    }
                                }
                        ...
                        try
                        {
                            ...
                            if (response.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(content))
                                {
                                    ...
                                    {
                                        lblStatus.Text = "Syncing retailer changes " + (i + 1) + " out of " + contactsresult.Count;
                    ...
                    if (resultCount > 0)
                    {
                        ...
                        if (changesresultCount > 0)
                        {
                            for (int i = 0; i < resultCount; i++)
                            {
                                try
                                {
                                    lblStatus.Text = "Getting retailer outlet data from local database";
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (crresultCount > 0)
                                                    {
                                                        if (crlastUpdated > crgetRetailerOutlet.Result[0].LastUpdated)
                                                        {
                                                            ...
                                                            await conn.InsertOrReplaceAsync(crretailer);
                                                            lblStatus.Text = "Syncing retailer outlet updates of " + crrCode;
                                                        }
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        await conn.InsertOrReplaceAsync(creretailer);
                                                        lblStatus.Text = "Syncing new retailer outlet (" + crrCode + ")";
                                                    }
                                                }
                                                catch (Exception ex)
                                                {
                                        ...
                                        for (int i = 0; i < chcontactsresult.Count; i++)
                                        {
                                            ...
                                            if (chresultCount > 0)
                                            {
                                                if (chlastUpdated > chgetRetailerOutlet.Result[0].LastUpdated)
                                                {
                                                    ...
                                                    await conn.InsertOrReplaceAsync(chretailer);
                                                    lblStatus.Text = "Syncing retailer outlet updates of " + chretailerCode;
                                                }
                                            }
                                            else
                                            {
                                                ...
                                                await conn.InsertOrReplaceAsync(cheretailer);
                                                lblStatus.Text = "Syncing new retailer outlet (" + chretailerCode + ")";
                                            }
                                        }
                                    }
                                }
                        ...
                        try
                        {
                            ...
                            if (response.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(content))
                                {
                                    ...
                                    for (int i = 0; i < contactsresult.Count; i++)
                                    {
                                        lblStatus.Text = "Syncing retailer outlet " + (i + 1) + " out of " + contactsresult.Count;
                    ...
                    if (resultCount > 0)
                    {
                        ...
                        if (changesresultCount > 0)
                        {
                            for (int i = 0; i < resultCount; i++)
                            {
                                try
                                {
                                    lblStatus.Text = "Getting field activity data from local database";
                        ...
                        try
                        {
                            ...
                            if (response.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(content))
                                {
                                    ...
                                    {
                                        lblStatus.Text = "Syncing field activity " + (i + 1) + " out of " + cafresult.Count;
                    ...
                    if (resultCount > 0)
                    {
                        ...
                        if (changesresultCount > 0)
                        {
                            for (int i = 0; i < resultCount; i++)
                            {
                                try
                                {
                                    lblStatus.Text = "Getting activity data from local database";
                                    ...
                                    var crping = new Ping();
                                    var crreply = ping.Send(new IPAddress(pingipaddress), 5000);

                                    if (crreply.Status == IPStatus.Success)
                                    {
                                        var crupdate_sql = "UPDATE tblActivity SET LastSync='" + current_datetime + "' WHERE CAFNo='" + crcafNo + "'";
                        ...
                        try
                        {
                            ...
                            if (response.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(content))
                                {
                                    ...
                                    {
                                        lblStatus.Text = "Syncing activity " + (i + 1) + " out of " + actresult.Count;
        ...
        public async void SyncSubscription(string host, string database, string contact, string ipaddress, byte[] pingipaddress)
        {
                    ...
                    if (resultCount > 0)
                    {
                        ...
                        if (changesresultCount > 0)
                        {
                            for (int i = 0; i < resultCount; i++)
                            {
                                try
                                {
                                    lblStatus.Text = "Getting device registration data from local database";
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (crresultCount > 0)
                                                    {
                                                        if (crlastUpdated > crgetSubscription.Result[0].LastUpdated)
                                                        {
                                                            ...
                                                            lblStatus.Text = "Syncing subscription updates of " + crregNumber;
                                                        }
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        lblStatus.Text = "Syncing new subscription (" + crregNumber + ")";
                                                    }
                                                }
                                                catch (Exception ex)
                                                {
                        ...
                        else
                        {
                            try
                            {
                                lblStatus.Text = "Getting device registration data from server";
                                        ...
                                        for (int i = 0; i < chsubresult.Count; i++)
                                        {
                                            ...
                                            if (chresultCount > 0)
                                            {
                                                if (chlastUpdated > chgetSubscription.Result[0].LastUpdated)
                                                {
                                                    ...
                                                    lblStatus.Text = "Syncing subscription updates of " + chregistrationNumber;
                                                }
                                            }
                                            else
                                            {
                                                ...
                                                lblStatus.Text = "Syncing new subscription (" + chregistrationNumber + ")";
                                            }
                                        }
                                    }
                                }
                        ...
                        try
                        {
                            ...
                            if (chresponse.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(chcontent))
                                {
                                    ...
                                    for (int i = 0; i < chsubresult.Count; i++)
                                    {
                                        lblStatus.Text = "Syncing device registration " + (i + 1) + " out of " + chsubresult.Count;
            ...
            {
                lblStatus.Text = "Syncing subscription failed. Server is unreachable.";
            }
        }
                    ...
                    if (resultCount > 0)
                    {
                        ...
                        if (changesresultCount > 0)
                        {
                            for (int i = 0; i < resultCount; i++)
                            {
                                try
                                {
                                    lblStatus.Text = "Getting user email data from local database";
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (crresultCount > 0)
                                                    {
                                                        if (crlUpdated > crgetEmail.Result[0].LastUpdated)
                                                        {
                                                            ...
                                                            lblStatus.Text = "Syncing user email updates of " + crcID;
                                                        }
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        lblStatus.Text = "Syncing new user email (" + crcID + ")";
                                                    }
                                                }
                                                catch (Exception ex)
                                                {
                        ...
                        else
                        {
                            try
                            {
                                lblStatus.Text = "Getting user email data from server";
                                        ...
                                        for (int i = 0; i < chemailresult.Count; i++)
                                        {
                                            ...
                                            if (chresultCount > 0)
                                            {
                                                if (chlastUpdated > chgetEmail.Result[0].LastUpdated)
                                                {
                                                    ...
                                                    lblStatus.Text = "Syncing user email updates of " + chcontactID;
                                                }
                                            }
                                            else
                                            {
                                                ...
                                                lblStatus.Text = "Syncing new user email (" + chcontactID + ")";
                                            }
                                        }
                                    }
                                }
                        ...
                        try
                        {
                            ...
                            if (chresponse.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(chcontent))
                                {
                                    ...
                                    for (int i = 0; i < chemailresult.Count; i++)
                                    {
                                        lblStatus.Text = "Syncing user email " + (i + 1) + " out of " + chemailresult.Count;
        ...
        public async void SyncProvince(string host, string database, string contact, string ipaddress, byte[] pingipaddress)
        {
            ...
            if (reply.Status == IPStatus.Success)
            {
                try
                {
                    ...
                    if (resultCount > 0)
                    {
                        try
                        {
                            lblStatus.Text = "Getting provinces from server";
                            ...
                            if (response.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(content))
                                {
                                    ...
                                    {
                                        lblStatus.Text = "Syncing provinces " + (i + 1) + " out of " + provinceresult.Count;
            ...
            {
                lblStatus.Text = "Syncing province failed. Server is unreachable.";
            }
        }
        ...
        public async void SyncTown(string host, string database, string contact, string ipaddress, byte[] pingipaddress)
        {
            ...
            if (reply.Status == IPStatus.Success)
            {
                try
                {
                    ...
                    if (resultCount > 0)
                    {
                        try
                        {
                            lblStatus.Text = "Getting towns from server";
                            ...
                            if (response.IsSuccessStatusCode)
                            {
                                ...
                                if (!string.IsNullOrEmpty(content))
                                {
                                    ...
                                    {
                                        lblStatus.Text = "Syncing towns " + (i + 1) + " out of " + townresult.Count;
            ...
            {
                lblStatus.Text = "Syncing town failed. Server is unreachable.";
            }
        }
